...
namespace Marketplace_3d_Assets.Migrations
{
    ...
    [Migration("20250402123642_FixAssetTagRelation")]
    partial class FixAssetTagRelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Marketplace_3d_Assets.DataAccess.Entities.AssetEntity", b =>
                {
                    ...
                    b.Property<Guid>("UserProfileProfile_Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Marketplace_3d_Assets.DataAccess.Entities.NetworkLinkEntity", b =>
                {
                    ...
                    b.Property<Guid?>("UserProfileEntityProfile_Id")
                        .HasColumnType("char(36)");

                    b.HasKey("Profile_Id", "Network_Name_Id");

                    b.HasIndex("UserProfileEntityProfile_Id");
            ...
            modelBuilder.Entity("Marketplace_3d_Assets.DataAccess.Entities.AssetEntity", b =>
                {
                    ...
                    b.HasOne("Marketplace_3d_Assets.DataAccess.Entities.UserProfileEntity", "UserProfile")
                        .WithMany("Assets")
            ...
            modelBuilder.Entity("Marketplace_3d_Assets.DataAccess.Entities.NetworkLinkEntity", b =>
                {
                    b.HasOne("Marketplace_3d_Assets.DataAccess.Entities.UserProfileEntity", null)
                        .WithMany("Network_Links")
                        .HasForeignKey("UserProfileEntityProfile_Id");
                });
